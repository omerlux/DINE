...
print('log save path: {}/dynamic_score_log.txt'.format(args.path))

log_file = os.path.join(args.path, 'dynamic_score_log.txt')
...
def evaluate():
    ...
    logging('BLEU_1(Cumulative 1-gram): %f' % bleu1)
    logging('BLEU_2(Cumulative 2-gram): %f' % bleu2)
    logging('BLEU_3(Cumulative 3-gram): %f' % bleu3)
    logging('BLEU_4(Cumulative 4-gram): %f' % bleu4)
